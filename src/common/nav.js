        ...
        children: [
            {
                ...
                icon: 'user',
                path: '/bathroom',
                component: dynamicWrapper(app, ['bathroom'], () => import('../routes/Bathroom/LevelList')),
            },
            {
                name: '卫生间列表',
                hidden: true,
                path: '/bathroom/:level',
                component: dynamicWrapper(app, ['bathroom'], () => import('../routes/Bathroom/RoomList')),
            },
            {
                name: '新建楼层信息',
                hidden: true,
                path: '/newlevel',
                component: dynamicWrapper(app, ['om'], () => import('../routes/Bathroom/NewLevel')),
            },
            {
                name: '商业分析',
                icon: 'dashboard',
