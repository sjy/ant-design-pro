                ...
                <Row gutter={24}>
                    ...
                    <Col {...topColResponsiveProps}>
                        <ChartCard
                            ...
                            total={numeral(812846).format('0,0')}
                            footer={<Field label="日客流量" value={numeral(10234).format('0,0')} />}
                            contentHeight={46}
                        >
                            <MiniArea color="#975FE4" height={46} data={visitData} />
                        </ChartCard>
                    </Col>
                    <Col {...topColResponsiveProps}>
                        <ChartCard
                            ...
                            total={numeral(65600).format('0,0')}
                            footer={<Field label="转化率" value="62.3%" />}
                            contentHeight={46}
                        >
                        ...
                        <Tabs tabBarExtraContent={salesExtra} size="large" tabBarStyle={{ marginBottom: 24 }}>
                                ...
                                <Row>
                                    ...
                                    <Col xl={8} lg={12} md={12} sm={24} xs={24}>
                                        <div className={styles.salesRank}>
                                            <h4 className={styles.rankingTitle}>商户销售额排名</h4>
                            ...
                            <TabPane tab="客流量" key="views">
                                <Row gutter={72}>
                                    ...
                                    <Col xl={8} lg={12} md={12} sm={24} xs={24}>
                                        <div className={styles.salesRank}>
                                            <h4 className={styles.rankingTitle}>商户客流量排名</h4>
                                            <ul className={styles.rankingList}>
                                                {rankingListData.map((item, i) => (
                                                    <li key={item.title}>
                                                        <span className={i < 3 && styles.active}>{i + 1}</span>
                                ...
                                <div className={styles.salesCardExtra}>
                                    ...
                                    <div className={styles.salesTypeRadio}>
                                        <Radio.Group value={salesType} onChange={this.handleChangeSalesType}>
                                            ...
                                            <Radio.Button value="offline">商户</Radio.Button>
                                        </Radio.Group>
                                    </div>
                                </div>
                            }
